import{_ as s,c as a,e,o as l}from"./app-DLY5LskL.js";const i={};function p(c,n){return l(),a("div",null,[...n[0]||(n[0]=[e(`<h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍"><span>介绍</span></a></h2><p>OpenClaw是一个开源的自动化工具项目，主要用于简化重复性任务的处理流程。它通过模块化设计，支持用户根据需求灵活组合功能，常见于数据处理、文件管理或系统运维等场景。该项目由社区驱动，强调可扩展性和易用性，适合开发者和技术爱好者快速构建定制化解决方案。</p><ul><li>项目主页：https://github.com/openclaw/openclaw</li><li>官方文档：http://docs.openclaw.ai/</li><li>运行时：<code>Node.js &gt;=22.12.0</code></li></ul><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><p>提示：OpenClaw不推荐运行在Windows系统上，Win上可以推荐WSL2</p><p>先安装NodeJS运行环境:</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token function">wget</span> <span class="token parameter variable">-c</span> https://nodejs.org/dist/v24.14.0/node-v24.14.0-linux-x64.tar.xz</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="npm包安装" tabindex="-1"><a class="header-anchor" href="#npm包安装"><span>npm包安装</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 或者使用pnpm安装: pnpm add -g openclaw@latest</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="源码安装" tabindex="-1"><a class="header-anchor" href="#源码安装"><span>源码安装</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token function">git</span> clone https://github.com/openclaw/openclaw.git</span>
...
<span class="line">Tip: run <span class="token variable"><span class="token variable">\`</span>openclaw doctor<span class="token variable">\`</span></span> to review skills + requirements.</span>
<span class="line">Docs: https://docs.openclaw.ai/skills</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="升级" tabindex="-1"><a class="header-anchor" href="#升级"><span>升级</span></a></h2><ul><li>升级指南：https://docs.openclaw.ai/zh-CN/install/updating</li></ul><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">openclaw update <span class="token parameter variable">--channel</span> beta</span>
<span class="line">openclaw update <span class="token parameter variable">--channel</span> dev</span>
<span class="line">openclaw update <span class="token parameter variable">--channel</span> stable</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="入门指南" tabindex="-1"><a class="header-anchor" href="#入门指南"><span>入门指南</span></a></h2><ul><li>完整入门指南（认证、配对、通道）：https://docs.openclaw.ai/zh-CN/start/getting-started</li></ul><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">openclaw onboard --install-daemon</span>
<span class="line"></span>
<span class="line">openclaw gateway <span class="token parameter variable">--port</span> <span class="token number">18789</span> <span class="token parameter variable">--verbose</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 发送测试消息</span></span>
<span class="line">openclaw message send <span class="token parameter variable">--to</span> +1234567890 <span class="token parameter variable">--message</span> <span class="token string">&quot;Hello from OpenClaw&quot;</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 链接到聊天助手 (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/IRC/Microsoft Teams/Matrix/Feishu/LINE/Mattermost/Nextcloud Talk/Nostr/Synology Chat/Tlon/Twitch/Zalo/Zalo Personal/WebChat)</span></span>
<span class="line">openclaw agent <span class="token parameter variable">--message</span> <span class="token string">&quot;Ship checklist&quot;</span> <span class="token parameter variable">--thinking</span> high</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>网关服务管理命令：</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">openclaw gateway <span class="token function">install</span></span>
<span class="line">openclaw gateway start</span>
<span class="line">openclaw gateway stop</span>
<span class="line">openclaw gateway restart</span>
<span class="line">openclaw gateway uninstall</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>参考：https://docs.openclaw.ai/cli/gateway</p>`,31)])])}const o=s(i,[["render",p]]),t=JSON.parse('{"path":"/ai/deploy/openclaw.html","title":"","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1773223584000,"contributors":[{"name":"Hankin","username":"Hankin","email":"554553400@qq.com","commits":3,"url":"https://github.com/Hankin"}],"changelog":[{"hash":"caedf889e3fb7ed08fef02234bcc5dcf27835807","time":1773223584000,"email":"554553400@qq.com","author":"Hankin","message":"UPDATE openclaw"},{"hash":"7127c5eb7dd6b3e3db837a0c6faf19a841a57b7a","time":1773222325000,"email":"554553400@qq.com","author":"Hankin","message":"UPDATE openclaw"},{"hash":"903ae6ef6e242b903c6285e9710b38ba1f6edb05","time":1773067037000,"email":"554553400@qq.com","author":"Hankin","message":"ADD OpenClaw"}]},"filePathRelative":"ai/deploy/openclaw.md"}');export{o as comp,t as data};
