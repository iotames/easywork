import{_ as n,c as a,e,o as i}from"./app-DcgBLLmq.js";const l={};function c(p,s){return i(),a("div",null,[...s[0]||(s[0]=[e(`<h2 id="项目下载" tabindex="-1"><a class="header-anchor" href="#项目下载"><span>项目下载</span></a></h2><ul><li>docker: version &gt;= 19.03.0+</li></ul><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token function">git</span> clone https://github.com/taigaio/taiga-docker.git</span>
