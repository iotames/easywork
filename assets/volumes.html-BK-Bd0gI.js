import{_ as e,c as n,e as a,o as l}from"./app-CdKSB2Uu.js";const i={};function d(c,s){return l(),n("div",null,[...s[0]||(s[0]=[a(`<p>Docker Compose的容器挂载和Docker Volumes</p><h2 id="配置示例" tabindex="-1"><a class="header-anchor" href="#配置示例"><span>配置示例</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">version: &#39;3.1&#39;</span>
