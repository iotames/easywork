import{k as e,p as t,u as n}from"./runtime-core.esm-bundler-DQVs2iiM.js";import{t as r}from"./plugin-vue_export-helper-DKl4mWgK.js";var i=JSON.parse(`{"path":"/devops/grafana/loki_nginx.html","title":"","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1752422697000,"contributors":[{"name":"Hankin","username":"Hankin","email":"hankin@catmes.com","commits":1,"url":"https://github.com/Hankin"}],"changelog":[{"hash":"dc1ff8ad7a266889c76b9ccb98473be4ad49392b","time":1752422697000,"email":"hankin@catmes.com","author":"Hankin","message":"ADD loki_nginx.md"}]},"filePathRelative":"devops/grafana/loki_nginx.md"}`),a={name:`loki_nginx.md`};function o(r,i,a,o,s,c){return e(),n(`div`,null,[...i[0]||=[t(`<h2 id="loki收集nginx日志" tabindex="-1"><a class="header-anchor" href="#loki收集nginx日志"><span>Loki收集nginx日志</span></a></h2><h3 id="修改nginx配置" tabindex="-1"><a class="header-anchor" href="#修改nginx配置"><span>修改nginx配置</span></a></h3><p>为了方便grafana dashbord展示，我们把日志格式修改为json</p><p><code>vim nginx.conf</code>:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">  log_format json escape=json &#39;{&#39;</span>
