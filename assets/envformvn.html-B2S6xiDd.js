import{_ as n,c as l,e as s,o as a}from"./app-D3rUnszu.js";const i={};function c(p,e){return a(),l("div",null,[...e[0]||(e[0]=[s(`<h2 id="环境变量注入配置文件的实现方案" tabindex="-1"><a class="header-anchor" href="#环境变量注入配置文件的实现方案"><span>环境变量注入配置文件的实现方案</span></a></h2><ol><li>​修改 pom.xml 配置</li></ol><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">&lt;build&gt;</span>
