import{A as e,D as t,E as n,F as r,I as i,O as a,R as o,f as s,k as c}from"./app-CLNwLC8N.js";var l=JSON.parse(`{"path":"/nginx/","title":"Nginx","lang":"zh-CN","frontmatter":{"title":"Nginx","order":17},"git":{"updatedTime":1786520319000,"contributors":[{"name":"Hankin","username":"Hankin","email":"whq78164@gmail.com","commits":7,"url":"https://github.com/Hankin"},{"name":"吴汉青","username":"","email":"554553400@qq.com","commits":1}],"changelog":[{"hash":"4b2b07034b089c869029b6e26948bf7d06d8bb65","time":1786520319000,"email":"554553400@qq.com","author":"吴汉青","message":"docs: 完善邮箱迁移方案，新增 Codex Agent 说明，补齐各 README frontmatter 并重排顶层目录顺序"},{"hash":"2d17a548cd5b6532dca581738f7f8f92cc82eca8","time":1776151412000,"email":"554553400@qq.com","author":"Hankin","message":"UPDATE vuepress"},{"hash":"9645ce5b7c63f3b4fe1eb4c8cbc5de24b8936fc9","time":1773994162000,"email":"554553400@qq.com","author":"Hankin","message":"ADD PHP"},{"hash":"fd289825fab5fedce7a998c8e07f381c58dbf3b4","time":1766455597000,"email":"554553400@qq.com","author":"Hankin","message":"UPDATE nginx/README.md"},{"hash":"c43135bb83678d73471215b9609150946934cd64","time":1751082170000,"email":"whq78164@gmail.com","author":"Hankin","message":"ADD nginxui.md"},{"hash":"8ccc8aa4bf9f6916bc5eddede3b30e66939637ac","time":1751017246000,"email":"whq78164@gmail.com","author":"Hankin","message":"UPDATE nginx md file. cicd.sh"},{"hash":"9320b9d51ebe9dac5b895941b1180d38f3478bfa","time":1750242607000,"email":"whq78164@gmail.com","author":"Hankin","message":"UPDATE nginx for docker"},{"hash":"d29f6d75fa1d1edf96a4bdb7f6b207c09932ca35","time":1745898409000,"email":"whq78164@gmail.com","author":"Hankin","message":"UPDATE docker-compose"}]},"filePathRelative":"nginx/README.md"}`),u={name:`README.md`};function d(s,l,u,d,f,p){let m=i(`RouteLink`);return r(),t(`div`,null,[l[1]||=a(`<h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><h3 id="linux" tabindex="-1"><a class="header-anchor" href="#linux"><span>Linux</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 安装nginx</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="windows" tabindex="-1"><a class="header-anchor" href="#windows"><span>Windows</span></a></h3><ul><li>nginx for Windows: https://nginx.org/en/docs/windows.html</li><li>nginx 下载: https://nginx.org/en/download.html</li><li>配置文件: <code>conf/nginx.conf</code></li></ul><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 启动NGINX</span></span>
<span class="line">start nginx.exe</span>
<span class="line"><span class="token comment"># 重新加载NGINX</span></span>
<span class="line">nginx.exe <span class="token parameter variable">-s</span> reload</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="配置" tabindex="-1"><a class="header-anchor" href="#配置"><span>配置</span></a></h2><ol><li>检查配置文件(<code>*.conf</code> 如: <code>conf/nginx.conf</code>)的 <code>root</code>, <code>index</code>, <code>fastcgi_param</code> 配置项</li></ol><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">fastcgi_param SCRIPT_FILENAME /scripts<span class="token variable">$fastcgi_script_name</span><span class="token punctuation">;</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 改为:</span></span>
<span class="line"></span>
...
<span class="line">fastcgi_param SCRIPT_FILENAME <span class="token variable">$realpath_root</span><span class="token variable">$fastcgi_script_name</span><span class="token punctuation">;</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="docker启动" tabindex="-1"><a class="header-anchor" href="#docker启动"><span>Docker启动</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token shebang important">#!/bin/bash</span></span>
<span class="line"></span>
<span class="line"><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token parameter variable">--network</span> <span class="token function">host</span> <span class="token parameter variable">--name</span> nginx <span class="token parameter variable">-v</span> /mnt/www:/mnt/www <span class="token parameter variable">-v</span> ~/vhost:/etc/nginx/conf.d</span>
...
<span class="line">  }</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="location语句块" tabindex="-1"><a class="header-anchor" href="#location语句块"><span>Location语句块</span></a></h2>`,24),n(`ul`,null,[n(`li`,null,[e(m,{to:`/nginx/location.html`},{default:o(()=>[...l[0]||=[c(`Location表达式`,-1)]]),_:1})])])])}var f=s(u,[[`render`,d]]);export{l as _pageData,f as default};