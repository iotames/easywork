import{D as e,F as t,O as n,f as r}from"./app-BvUU5elJ.js";var i=JSON.parse(`{"path":"/devops/taiga/start_docker.html","title":"","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1752747784000,"contributors":[{"name":"Hankin","username":"Hankin","email":"whq78164@gmail.com","commits":1,"url":"https://github.com/Hankin"}],"changelog":[{"hash":"619e8fa004878f73536aef1148b73bedff1f7608","time":1752747784000,"email":"whq78164@gmail.com","author":"Hankin","message":"ADD taiga"}]},"filePathRelative":"devops/taiga/start_docker.md"}`),a={name:`start_docker.md`};function o(r,i,a,o,s,c){return t(),e(`div`,null,[...i[0]||=[n(`<h2 id="项目下载" tabindex="-1"><a class="header-anchor" href="#项目下载"><span>项目下载</span></a></h2><ul><li>docker: version &gt;= 19.03.0+</li></ul><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token function">git</span> clone https://github.com/taigaio/taiga-docker.git</span>
