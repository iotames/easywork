import{_ as n,c as a,e,o as l}from"./app-CoWQeDNb.js";const p={};function i(t,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h2 id="makefile简介" tabindex="-1"><a class="header-anchor" href="#makefile简介"><span>Makefile简介</span></a></h2><p>为了简化多个源代码文件下，通过 <code>gcc</code> 工具编译复杂的C语言项目，出现了 <code>Makefile</code>。</p><p>只要把 <code>GCC</code> 的各种控制和编译选项编写到 <code>Makefile</code> 文件中，再使用 <code>make</code> 工具解析，然后调用 GCC 执行编译即可，实现编译（构建）自动化。</p><h2 id="makefile规则" tabindex="-1"><a class="header-anchor" href="#makefile规则"><span>Makefile规则</span></a></h2><p>整体规则:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">&lt;target&gt; : &lt;prerequisites&gt;</span>
