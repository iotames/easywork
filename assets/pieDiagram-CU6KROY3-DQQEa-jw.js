import{t as e}from"./chunk-AQ6EADP3-GV2odpVK.js";import{y as t}from"./chunk-KGYTTC2M-COOqldZT.js";import{t as n}from"./chunk-JQRUD6KW-CDkxhS7a.js";import{W as r,c as i,p as a,q as o}from"./chunk-7W6UQGC5-CRfVEQz2.js";import{F as s,H as c,I as l,K as u,N as d,S as f,Y as p,Z as m,j as h,tt as g}from"./chunk-67TQ5CYL-BNI2IkSj.js";import{t as _}from"./chunk-LRIF4GLE-D7RRk1cS.js";import"./chunk-KNLZD3CH-pfkZXG6P.js";import{a as v,p as y}from"./chunk-QA3QBVWF-DjKs4Jo5.js";var b=h.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:e(()=>structuredClone(w),`getConfig`),clear:e(()=>{S=new Map,C=x.showData,p()},`clear`),setDiagramTitle:s,getDiagramTitle:u,setAccTitle:d,getAccTitle:g,setAccDescription:c,getAccDescription:f,addSection:e(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),o.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:e(()=>S,`getSections`),setShowData:e(e=>{C=e},`setShowData`),getShowData:e(()=>C,`getShowData`)},E=e((e,t)=>{n(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:e(async e=>{let n=await t(`pie`,e);o.debug(n),E(n,T)},`parse`)},O=e(e=>`
  .pieCircle{
