import{_ as n,c as e,e as a,o as l}from"./app-B0UrfQJy.js";const i={};function d(r,s){return l(),e("div",null,[...s[0]||(s[0]=[a(`<h2 id="systemd-journal-系统日志" tabindex="-1"><a class="header-anchor" href="#systemd-journal-系统日志"><span>Systemd Journal 系统日志</span></a></h2><p>日志配置：</p><p><code>vim /etc/systemd/journald.conf</code></p><div class="language-conf line-numbers-mode" data-highlighter="prismjs" data-ext="conf"><pre><code class="language-conf"><span class="line">[Journal]</span>
