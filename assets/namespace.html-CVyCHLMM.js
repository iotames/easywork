import{_ as n,c as a,e,o as l}from"./app-CdKSB2Uu.js";const p={};function i(t,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h2 id="命名空间" tabindex="-1"><a class="header-anchor" href="#命名空间"><span>命名空间</span></a></h2><ul><li>工作流组件-命名空间：https://kestra.io/docs/workflow-components/namespace</li></ul><p>可以使用嵌入式代码编辑器和 <code>命名空间文件</code> 在命名空间级别组织您的代码，并可以选择从 <code>Git</code> 同步这些文件</p><h2 id="命名空间文件" tabindex="-1"><a class="header-anchor" href="#命名空间文件"><span>命名空间文件</span></a></h2><ol><li><p>概念 - 命名空间文件：https://kestra.io/docs/concepts/namespace-files</p></li><li><p>版本控制与 CI/CD - 版本控制与 Git：https://kestra.io/docs/version-control-cicd/git</p></li></ol><p>您可以将您的 Git 仓库与特定的命名空间同步，以协调 dbt、Terraform 或 Ansible，或任何包含代码和配置文件的其他项目。</p><p>一旦您将任何文件添加到命名空间中，您可以使用来自同一命名空间的 <code>EVERY</code> 任务或触发器中的 <code>read()</code> 函数在流程中引用它。</p><p>命名空间文件，存储在命名空间目录的 <code>_files</code> 子目录中，允许您在工作流中使用 <code>read()</code> 函数读取文件内容。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">.</span>
