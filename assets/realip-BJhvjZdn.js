import{D as e,F as t,O as n,f as r}from"./app-By77jtL8.js";var i=JSON.parse(`{"path":"/nginx/realip.html","title":"","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1758685450000,"contributors":[{"name":"Hankin","username":"Hankin","email":"554553400@qq.com","commits":1,"url":"https://github.com/Hankin"}],"changelog":[{"hash":"7123bb51ac334816ca4e66e4bb49b5967d44aa7d","time":1758685450000,"email":"554553400@qq.com","author":"Hankin","message":"ADD realip.md for nginx"}]},"filePathRelative":"nginx/realip.md"}`),a={name:`realip.md`};function o(r,i,a,o,s,c){return t(),e(`div`,null,[...i[0]||=[n(`<h2 id="http请求头ip和tcp源ip" tabindex="-1"><a class="header-anchor" href="#http请求头ip和tcp源ip"><span>HTTP请求头IP和TCP源IP</span></a></h2><p>打破砂锅问到底：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">下面两个HTTP请求头的含义是什么？有何区别？</span>
