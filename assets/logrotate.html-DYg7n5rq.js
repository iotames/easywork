import{_ as n,c as a,e,o as l}from"./app-D3rUnszu.js";const i={};function d(o,s){return l(),a("div",null,[...s[0]||(s[0]=[e(`<h2 id="logrotate介绍" tabindex="-1"><a class="header-anchor" href="#logrotate介绍"><span>logrotate介绍</span></a></h2><p>Logrotate 是 Linux 系统中用于自动化管理日志文件的工具，能够高效、安全地轮转、压缩、清理日志文件，防止磁盘空间被耗尽，同时保留必要的历史日志以便问题排查。</p><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token function">apt</span> <span class="token function">install</span> <span class="token function">logrotate</span></span>
