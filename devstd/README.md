...
- datastruct.md: [SQL和数据](datastruct.md)
- erpsysarch.md: [系统架构设计](erpsysarch.md)
...
项目管理全周期：立项，开发，跟进，交付，验收，使用，反馈。

缺少必要环节，可能导致交付后，业务部门因各种原因没使用，也不知道责任在谁。其中有些非紧急需求，交付后，没使用，拖着拖着就没了。浪费人力。
