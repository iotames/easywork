...
- gitlab: [Gitlab主题](gitlab/)
- cicd.sh: [持续集成脚本](cicd.sh)
- gitlab-ci.yml: [Gitlab CI/CD流水线配置](gitlab-ci.yml)
- redis.md: [Redis相关](redis.md)
- setenv.md: [设置环境变量](setenv.md)


## 项目管理

项目管理全周期：立项，开发，跟进，交付，验收，使用，反馈。全部做起来，才能闭环。否则可能交付后，业务部门因各种原因不用了，也不知道责任在谁。
